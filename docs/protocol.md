        # Hta Artifact Standard V2: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/hta-artifact-standard-v2.git

        ## Objective

        HTA Artifact Standard v2 is an open-source HTA platform with 41 simulation and analysis engines, deterministic reproducibility, and comprehensive test coverage, with an F1000 paper completed.
        ...
        - Code: https://github.com/mahmood726-cyber/hta-artifact-standard-v2.git
