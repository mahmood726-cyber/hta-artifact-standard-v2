/**
 * Service Worker for HTA Artifact Standard
...
const CACHE_NAME = 'hta-pro-v1.0.1';
const RUNTIME_CACHE = 'hta-pro-runtime-v1.0.1';
  ...
  event.waitUntil(
    (async () => {
      ...
      try {
        ...
        console.warn('[Service Worker] Precache skipped one or more assets:', error);
      }
...
async function getSessionDataFromIndexedDB() {
  return new Promise((resolve, reject) => {
    const request = indexedDB.open('HTAPro', 1);
